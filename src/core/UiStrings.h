...
static constexpr const char* EXPLORE_SUN_BARK         = "Sun-baked bark! Wood +1";
...
static constexpr const char* EXPLORE_CRACKED_STUMP    = "Cracked stump! Wood +1";
...
static constexpr const char* EXPLORE_MOSS_CARPET      = "Moss carpet! +2 +wood";
...
static constexpr const char* EXPLORE_FAIRY_RING       = "Fairy ring! +3 +wood";
...
static constexpr const char* EXPLORE_HEART_OF_ROT     = "Heart of rot! Wood +1";
