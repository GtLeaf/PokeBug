...
static constexpr const char* BACK_TO_GIFT = "back to gift"; // 返回礼物菜单
...
static constexpr const char* UNLOCKED_AS_ADULT = "Unlocked as adult.";
...
static constexpr const char* MENU_DEBUG_UNLOCK_ALL = "Unlock All";
...
static constexpr const char* VISIT_TITLE        = "VISIT";
static constexpr const char* VISIT_WAITING      = "VISITING";
static constexpr const char* VISIT_CONNECTED    = "Visitor arrived!";
static constexpr const char* VISIT_AWAY_TITLE   = "Visiting...";
static constexpr const char* VISIT_LEFT_FMT     = "%u min left";
static constexpr const char* VISIT_RECALL_HINT  = "B:Recall";
static constexpr const char* VISIT_RECALL_CONFIRM = "Recall beetle?";
static constexpr const char* VISIT_RECALL_NAV     = "A:Yes  B:No";
static constexpr const char* VISIT_SOCIAL_LOCKED  = "Visit active.";
...
static constexpr const char* GIFT_AMOUNT_ZERO   = "Choose amount.";    // 请选择数量
static constexpr const char* GIFT_AMOUNT_TITLE_FMT = "%s x %u/%u";     // 礼物数量选择
...
static constexpr const char* TOY_BALL_BROKE     = "Ball broke.";
static constexpr const char* TOY_BALL_LOCKED    = "Ball locked.";
static constexpr const char* TOY_BALL_EMPTY     = "No ball left.";
...
static constexpr const char* EXPLORE_RELEASE_EVENT    = "Breeding site";
static constexpr const char* EXPLORE_RELEASE_CONFIRM  = "Release beetle?";
static constexpr const char* EXPLORE_RELEASE_EGG      = "It will leave an egg...";
static constexpr const char* EXPLORE_RELEASE_ACTION   = "A:Release";
static constexpr const char* EXPLORE_RELEASED         = "Released";
static constexpr const char* EXPLORE_NEW_EGG          = "A new egg awaits";
...
static constexpr const char* MENU_SOCIAL_VISIT        = "Visit";
static constexpr const char* MENU_GIFT_FOOD           = "Food";
static constexpr const char* MENU_GIFT_TOY            = "Toy";
static constexpr const char* MENU_GIFT_RECEIVE        = "Receive";
