...
void setup() {
    ...
    if (cause == ESP_SLEEP_WAKEUP_TIMER) {
        ...
        SaveManager::ins().loadSettings(fontScale, brightness, gameSpeed, idleTimeout, mainSceneBg);
        ...
        SaveManager::ins().saveSettings(fontScale, brightness, gameSpeed, idleTimeout, mainSceneBg);
