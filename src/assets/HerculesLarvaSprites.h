...
static constexpr uint8_t WALK_FRAME_COUNT = 5;
static constexpr uint8_t SLEEP_FRAME_COUNT = 3;
static constexpr uint8_t EAT_FRAME_COUNT = 3;
static constexpr uint8_t IDLE_FRAME_W = 91;
static constexpr uint8_t IDLE_FRAME_H = 62;
static constexpr uint8_t WALK_FRAME_W = 91;
static constexpr uint8_t WALK_FRAME_H = 62;
